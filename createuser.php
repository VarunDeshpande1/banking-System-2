      ...
      <div class="screen-body">
        ...
        <div class="screen-body-item">
          <form class="app-form" method="post">
            ...
            <div class="app-form-group">
              <input class="app-form-control" placeholder="PASSWORD" type="text" name="password" required>
            </div>
            <div class="app-form-group">
            ...
            <div class="app-form-group button">
              <input class="app-form-button btn btn-primary" type="submit" value="SIGN-UP" name="submit"></input>
